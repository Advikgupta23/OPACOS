pro extin, glong, glat, dist, ebv, av
...
r0=8.27             ; adopted distance of the Galactic center
conv=!pi/180.
...
zc = 0.02                 ; shift takes in to account that the sun is not 
