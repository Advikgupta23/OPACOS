...
galactic_longitude=270.0
galactic_latitude=-73.0
survey_area=10.0
...
imf_type='kroupa' # You can use three IMF systems while generating the probability (passed in data_cube.py) : * 'salpeter' 
                    #                                                                                           * 'kroupa'  
                    #                                                                                            * 'chabrierlognormal'.
extinction_mode='out_plane' # 'in_plane' for the computation of extinction using extinction due to spiral arms and schlegel maps (passed in data_cube.py).
                            # 'out_plane' for the computation of extinction using extinction using general schlegel maps (passed in data_cube.py).
age_distribution=True #If you want to infer model age distribution for the section of targeted sky set it to be True otherwise False. 
feh_distribution=False  #If you want to infer model feh distribution for the section of targeted sky set it to be True otherwise False.
